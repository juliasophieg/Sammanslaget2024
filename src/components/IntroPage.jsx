        ...
        <section style={{ display: "flex", width: "100%" }}>
          ...
          >
            <p>
              ...
              karta låter dig utforska, läsa och lyssna på berättelser från de
              som gått samma vägar som du. Här kan du också skapa och dela dina
              egna minnen, sätta dina fotavtryck och låta musiken du väljer
              sätta tonen.
            </p>
            <p>
